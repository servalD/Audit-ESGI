...
/*
Contract address: 0xAf32e1287cc1d80635E6Fd39E969E79F5d519e16

Rendu:
  Repo GitHub avec un readme expliquant chaque failles trouvée
  Script de déploiement et hack local et sur testnet
  Code propre et commenté
*/

pragma solidity 0.7.0;

interface Building {// Elevator like
    function isLastFloor(uint256) external returns (bool);
}

contract HackMeIfYouCan {
    uint256 FACTOR =
        6275657625726723324896521676682367236752985978263786257989175917; // Coin flip like
    ...
    function flip(bool _guess) public whenUnlocked returns (bool) {// Coin flip like TODO!
